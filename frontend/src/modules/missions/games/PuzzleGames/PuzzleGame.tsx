...
const SATELLITES: SatelliteInfo[] = [
  {
    ...
    info: 'GPS (Global Positioning System) — спутниковая система навигации...',
    launchYear: '1978',
    country: 'США',
    orbitHeight: '20 200 км',
    funFact: 'GPS-спутники несут атомные часы...',
  },
  {
    id: 'hubble',
    name: 'Телескоп Хаббл',
    image: '/assets/src/hubble.jpg',
    info: 'Космический телескоп Хаббл — автоматическая обсерватория...',
    launchYear: '1990',
    country: 'США / ЕКА',
    orbitHeight: '547 км',
    funFact: 'Хаббл делает около 150 гигабайт научных данных каждую неделю...',
  },
  {
    id: 'iss',
    name: 'МКС',
    image: '/assets/src/iss.jpg',
    info: 'Международная космическая станция...',
    launchYear: '1998',
    country: 'Международный проект',
    orbitHeight: '408 км',
    funFact: 'МКС движется со скоростью 7,66 км/с...',
  },
  {
    id: 'voyager',
    name: 'Voyager-1',
    image: '/assets/src/voyager.jpg',
    info: 'Voyager-1 — автоматический зонд для исследования дальнего космоса...',
    launchYear: '1977',
    country: 'США',
    orbitHeight: '24+ млрд км от Земли',
    funFact: 'Voyager-1 несёт золотую пластинку...',
  },
];
      ...
      >
        <div className={styles.titleBar} onMouseDown={handleTitleMouseDown}>
          ...
          <div className={styles.titleButtons}>
            ...
            <button className={`${styles.titleBtn} ${styles.closeWinBtn}`} onClick={handleCloseWithWin}>✕</button>
          </div>
        </div>
        ...
        <div className={styles.windowBody}>
          ...
          {gameOver && screen === 'game' && (
            <div className={styles.gameOverlay}>
              ...
              {!gameWon && (
                <p>Собрано: {pieces.filter(p => p.placed).length}/{selectedLevel.pieces}</p>
              )}
              <div className={styles.gameOverButtons}>
                {!gameWon && (
                  <button onClick={() => startGame()}>ПОВТОРИТЬ</button>
                )}
                <button onClick={handleCloseWithWin}>
                  {gameWon ? 'ЗАКРЫТЬ' : 'К УРОВНЯМ'}
                </button>
              </div>
            </div>
          )}
