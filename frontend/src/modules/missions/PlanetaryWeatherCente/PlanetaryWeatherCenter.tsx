...
import type { PlanetId, WeatherEvent } from './types';
import { PLANETS_DATA, WEATHER_EVENTS } from './config';
    ...
    <div className={`${styles.overlay} ${isMaximized ? styles.maximized : ''}`}>
      ...
      >
        ...
        <div className={styles.windowBody}>
          ...
          {screen === 'main' && (
            <>
              {/* Верхняя панель с выбором планеты — белые кружочки */}
              ...
              <div className={styles.mainContent}>
                ...
                <div className={styles.infoPanel}>
                  ...
                  {/* Погодные явления — пастельно-фиолетовые кнопки */}
